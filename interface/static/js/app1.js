...
(function() {
  'use strict';
  var App, CommentThumb, CommentsDeck, Deck, FeedDeck, FeedThumb, FilmThumb, FilmsDeck, Item, Page, Page_Feed, Page_Film, Page_Login, Page_Main, Page_Person, Page_Playlist, Page_Register, Page_Search, PersonThumb, PersonsDeck, Player, check_app_is_init, error, state_toggle,
    ...
    FilmThumb.prototype.set_vals = function(vals, do_not_set) {
      ...
      if (vals.locations && vals.locations.length) {
        ...
        if (!vals.hasFree && vals.price) {
          ...
          this.elements["btn_price"].self.show();
  ...
  Page_Playlist = (function(_super) {
    ...
    function Page_Playlist(conf) {
      ...
      if (this._e.playlist_btn.length) {
        this._e.playlist_btn.bind("click", (function(_this) {
          return function() {
            return _this.action_playlist_toggle(false);
          };
        })(this));
      }
  ...
  Page_Feed = (function(_super) {
    ...
    Page_Feed.prototype.load_more_films = function(deck) {
      var current_counter;
      current_counter = deck.load_counter;
      deck.load_more_hide();
