...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (static_url, img_url, noavatar_url, nophoto_url, noposter_url, js_url, css_url, IN_PRODUCTION, location_names, quality_texts, months, date_now, Date, undefined, parseInt, Math, res, min, start_date, generic_title, title, title_orig, pg_rating, poster_url, url, watching_users_count, curr_date, end_date, start_date_class, is_online, has_free, min_price, price_loc, btn_cls, price_loc_cnt, i, obj, url_loc, url_btn, btn_text, title_alt, time_to_wait_str, status_details_text, status_label_text, status_label_class, start_in_minutes, text, cast) {
static_url = "/static/"
