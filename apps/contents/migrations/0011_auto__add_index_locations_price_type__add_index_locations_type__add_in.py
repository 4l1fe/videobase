...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Locations', fields ['price_type']
        db.create_index('locations', ['price_type'])

        # Adding index on 'Locations', fields ['type']
        db.create_index('locations', ['type'])

        # Adding index on 'Locations', fields ['price']
        db.create_index('locations', ['price'])


    def backwards(self, orm):
        # Removing index on 'Locations', fields ['price']
        db.delete_index('locations', ['price'])

        # Removing index on 'Locations', fields ['type']
        db.delete_index('locations', ['type'])

        # Removing index on 'Locations', fields ['price_type']
        db.delete_index('locations', ['price_type'])
    ...
    models = {
        ...
        'contents.about': {
            'Meta': {'object_name': 'About', 'db_table': "'about'"},
        ...
        'contents.legal': {
            'Meta': {'object_name': 'Legal', 'db_table': "'legal'"},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        ...
        'contents.locations': {
            ...
            'price_type': ('django.db.models.fields.SmallIntegerField', [], {'db_index': 'True'}),
            'quality': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'subtitles': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '40', 'db_index': 'True'}),
