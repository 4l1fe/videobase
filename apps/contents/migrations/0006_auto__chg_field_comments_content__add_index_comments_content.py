...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Comments.content' to match new field type.
        db.rename_column('comments', 'content', 'content_id')
        # Changing field 'Comments.content'
        db.alter_column('comments', 'content_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contents.Contents']))
        # Adding index on 'Comments', fields ['content']
        db.create_index('comments', ['content_id'])


    def backwards(self, orm):
        # Removing index on 'Comments', fields ['content']
        db.delete_index('comments', ['content_id'])


        # Renaming column for 'Comments.content' to match new field type.
        db.rename_column('comments', 'content_id', 'content')
        # Changing field 'Comments.content'
        db.alter_column('comments', 'content', self.gf('django.db.models.fields.IntegerField')())
