...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Locations.value'
        db.delete_column('locations', 'value')

        # Adding field 'Locations.url_view'
        db.add_column('locations', 'url_view',
                      self.gf('django.db.models.fields.URLField')(max_length=255))


    def backwards(self, orm):
        # Adding field 'Locations.value'
        db.add_column('locations', 'value',
                      self.gf('django.db.models.fields.CharField')(max_length=40))

        # Deleting field 'Locations.url_view'
        db.delete_column('locations', 'url_view')
