...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Locations.lang'
        db.add_column('locations', 'lang', self.gf('django.db.models.fields.CharField')(max_length=40))


    def backwards(self, orm):
        # Deleting field 'Locations.lang'
        db.delete_column('locations', 'lang')
