...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KinopoiskTries.page_dump'
        db.add_column('robots_kinopoisk_tries', 'page_dump',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KinopoiskTries.page_dump'
        db.delete_column('robots_kinopoisk_tries', 'page_dump')
