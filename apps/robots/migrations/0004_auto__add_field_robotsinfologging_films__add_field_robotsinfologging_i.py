...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RobotsInfoLogging.films'
        db.add_column('robots_logging_info', 'films',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'RobotsInfoLogging.is_new_location'
        db.add_column('robots_logging_info', 'is_new_location',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RobotsInfoLogging.films'
        db.delete_column('robots_logging_info', 'films')

        # Deleting field 'RobotsInfoLogging.is_new_location'
        db.delete_column('robots_logging_info', 'is_new_location')
