...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RobotsInfoLogging'
        db.create_table('robots_logging_info', (
        ...
        db.send_create_signal('robots', ['RobotsInfoLogging'])


    def backwards(self, orm):
        # Deleting model 'RobotsInfoLogging'
        db.delete_table('robots_logging_info')
