...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LocationsCorrectorLogging'
        db.create_table('locations_corrector_logging', (
        ...
        db.send_create_signal('robots', ['LocationsCorrectorLogging'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'LocationsCorrectorLogging'
        db.delete_table('locations_corrector_logging')
    ...
    models = {
        ...
        'robots.locationscorrectorlogging': {
            'Meta': {'object_name': 'LocationsCorrectorLogging', 'db_table': "'locations_corrector_logging'"},
