...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('films', 'rating_local_cnt', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Adding index on 'UsersFilms', fields ['status']
        db.create_index('users_films', ['status'])

        # Adding index on 'UsersFilms', fields ['rating']
        db.create_index('users_films', ['rating'])


    def backwards(self, orm):
        # Removing index on 'UsersFilms', fields ['rating']
        db.delete_index('users_films', ['rating'])

        # Removing index on 'UsersFilms', fields ['status']
        db.delete_index('users_films', ['status'])
