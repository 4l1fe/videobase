...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FilmExtras.url'
        db.alter_column('films_extras', 'url', self.gf('django.db.models.fields.URLField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'FilmExtras.url'
        db.alter_column('films_extras', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=255))
