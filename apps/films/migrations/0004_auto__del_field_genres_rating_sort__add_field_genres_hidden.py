...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Genres.rating_sort'
        db.delete_column('genres', 'rating_sort')

        # Adding field 'Genres.hidden'
        db.add_column('genres', 'hidden',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Genres.rating_sort'
        db.add_column('genres', 'rating_sort',
                      self.gf('django.db.models.fields.SmallIntegerField')(blank=True, null=True, db_index=True),
                      keep_default=False)

        # Deleting field 'Genres.hidden'
        db.delete_column('genres', 'hidden')
