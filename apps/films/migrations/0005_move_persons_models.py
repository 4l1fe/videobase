...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'films.personsextras': {
            ...
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['films.Persons']", 'max_length': '255'}),
        ...
        u'films.personsfilms': {
            ...
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['films.Persons']"})
        },
        u'films.seasons': {
