...
class Films(models.Model):
    ...
    fduration        = models.IntegerField(verbose_name=u'Продолжительность фильма', null=True)
    fbudget          = models.IntegerField(verbose_name=u'Бюджет фильма')
    ...
    kinopoisk_id     = models.IntegerField(verbose_name=u'Порядковый номер на кинопоиске')
    age_limit        = models.PositiveSmallIntegerField(verbose_name=u'Ограничение по возрасту')
    kinopoisk_lastupdate = models.DateTimeField(verbose_name=u'Дата последнего обновления на кинопоиске')
