...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Films.subscribed_cnt'
        db.add_column('films', 'subscribed_cnt',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Films.subscribed_cnt'
        db.delete_column('films', 'subscribed_cnt')
