...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'CastsLocations', fields ['price_type']
        db.create_index('casts_locations', ['price_type'])


        # Changing field 'CastsServices.update'
        db.alter_column('casts_services', 'update', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'CastsChats.cast'
        db.alter_column('casts_chats', 'cast_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['casts.Casts'], unique=True))

    def backwards(self, orm):
        # Removing index on 'CastsLocations', fields ['price_type']
        db.delete_index('casts_locations', ['price_type'])


        # Changing field 'CastsServices.update'
        db.alter_column('casts_services', 'update', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=0))

        # Changing field 'CastsChats.cast'
        db.alter_column('casts_chats', 'cast_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['casts.Casts'], unique=True))
