...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CastsExtras'
        db.create_table('extras_casts', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cast', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['casts.Casts'])),
            ('extra', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['films.FilmExtras'])),
        ))
        db.send_create_signal('casts', ['CastsExtras'])

        # Adding unique constraint on 'CastsChats', fields ['cast']
        db.create_unique('casts_chats', ['cast_id'])

        # Adding field 'Casts.search_index'
        db.add_column('casts', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'CastsChats', fields ['cast']
        db.delete_unique('casts_chats', ['cast_id'])
        ...
        # Deleting model 'CastsExtras'
        db.delete_table('extras_casts')

        # Deleting field 'Casts.search_index'
        db.delete_column('casts', 'search_index')
