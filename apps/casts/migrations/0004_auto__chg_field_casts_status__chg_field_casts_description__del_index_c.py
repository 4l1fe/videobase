...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Casts.status'
        db.alter_column('casts', 'status', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Casts.description'
        db.alter_column('casts', 'description', self.gf('django.db.models.fields.TextField')(max_length=255, null=True))
        # Removing index on 'Casts', fields ['description']
        db.delete_index('casts', ['description'])


        # Changing field 'Casts.pg_rating'
        db.alter_column('casts', 'pg_rating', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Removing index on 'Casts', fields ['pg_rating']
        db.delete_index('casts', ['pg_rating'])


    def backwards(self, orm):
        # Adding index on 'Casts', fields ['pg_rating']
        db.create_index('casts', ['pg_rating'])

        # Adding index on 'Casts', fields ['description']
        db.create_index('casts', ['description'])


        # Changing field 'Casts.status'
        db.alter_column('casts', 'status', self.gf('django.db.models.fields.CharField')(default='offline', max_length=255))

        # Changing field 'Casts.description'
        db.alter_column('casts', 'description', self.gf('django.db.models.fields.TextField')(default='', max_length=255))

        # Changing field 'Casts.pg_rating'
        db.alter_column('casts', 'pg_rating', self.gf('django.db.models.fields.CharField')(default=1, max_length=255))
