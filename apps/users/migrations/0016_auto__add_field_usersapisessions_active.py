...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UsersApiSessions.active'
        db.add_column('users_api_sessions', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UsersApiSessions.active'
        db.delete_column('users_api_sessions', 'active')
