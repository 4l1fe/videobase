...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        raise RuntimeError("Cannot reverse this migration. 'Feed.object' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Feed.object'
        db.add_column(u'users_feed', 'object',
