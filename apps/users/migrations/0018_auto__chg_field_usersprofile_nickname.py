...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UsersProfile.nickname'
        db.alter_column('users_profile', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'UsersProfile.nickname'
        db.alter_column('users_profile', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=128))
