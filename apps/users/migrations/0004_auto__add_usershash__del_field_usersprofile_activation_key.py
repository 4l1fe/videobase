...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'UsersProfile.activation_key'
        raise RuntimeError("Cannot reverse this migration. 'UsersProfile.activation_key' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'UsersProfile.activation_key'
