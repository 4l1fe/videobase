...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Users.last_login'
        db.add_column('users', 'last_login',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


        # Changing field 'Users.password'
        db.alter_column('users', 'password', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):
        # Deleting field 'Users.last_login'
        db.delete_column('users', 'last_login')


        # Changing field 'Users.password'
        db.alter_column('users', 'password', self.gf('django.db.models.fields.CharField')(max_length=255))
