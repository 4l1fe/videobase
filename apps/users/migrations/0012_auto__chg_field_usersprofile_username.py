...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UsersProfile.username'
        db.alter_column('users_profile', 'username', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'UsersProfile.username'
        db.alter_column('users_profile', 'username', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
    ...
    models = {
        ...
        'users.usersprofile': {
            ...
            'username': ('django.db.models.fields.CharField', [], {'default': "'NoneName'", 'max_length': '128', 'blank': 'True'}),
