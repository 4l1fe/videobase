...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UsersProfile.username'
        db.delete_column('users_profile', 'username')

        # Adding field 'UsersProfile.nickname'
        db.add_column('users_profile', 'nickname',
                      self.gf('django.db.models.fields.CharField')(default='NoneName', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UsersProfile.username'
        db.add_column('users_profile', 'username',
                      self.gf('django.db.models.fields.CharField')(default='NoneName', max_length=128, blank=True),
                      keep_default=False)

        # Deleting field 'UsersProfile.nickname'
        db.delete_column('users_profile', 'nickname')
